 ...
 */
typedef wasm_trap_t *(
    wasmtime_func_async_continuation_callback_t)(void *env,
...
WASM_API_EXTERN wasmtime_async_continuation_t *wasmtime_async_continuation_new(
    wasmtime_func_async_continuation_callback_t *callback, void *env,
    void (*finalizer)(void *));
...
wasmtime_func_call_async(wasmtime_context_t *context,
                         const wasmtime_func_t *func);

/**
 * TODO
 */
WASM_API_EXTERN void wasmtime_call_future_delete(wasmtime_call_future_t *fut);

/**
 * TODO
 */
WASM_API_EXTERN bool wasmtime_call_future_poll(wasmtime_call_future_t *fut);

/**
 * TODO
 */
WASM_API_EXTERN wasmtime_error_t *
wasmtime_call_future_get_results(wasmtime_call_future_t *fut,
                                 wasm_trap_t **trap);
